  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:max-w-4xl md:ml-auto">
        ...
        <div 
          className={cn(
            "rounded-[32px] md:rounded-[40px] px-6 md:pl-10 md:pr-24 py-8 md:pb-10 bg-[var(--color-primary)] text-[var(--color-on-primary)] shadow-inner flex flex-col",
        ...
        >
          ...
          <div className="mb-6">
            ...
            <span className="block text-sm text-white/80 mt-1">Monthly</span>
          </div>
        ...
        <div 
          className={cn(
            "rounded-[32px] md:rounded-[40px] px-6 md:pl-10 md:pr-24 py-8 md:pb-10 bg-white shadow-[0_4px_16px_rgba(0,0,0,0.08)] flex flex-col",
            isInView ? "animate-fade-in-up" : "opacity-0"
          )}
          style={{ animationDelay: '0.2s' }}
        >
          <h4 className="text-[22px] font-medium text-[var(--color-ink)] mb-3">Brand Authority Audit</h4>
          <p className="text-[var(--color-muted)] mb-8 flex-grow">
            Fixed scope, actionable roadmap. <br/>
            The blueprint to outrank your competitors.
          </p>
          <div className="mb-6">
            <span className="text-2xl font-serif text-[var(--color-ink)]">$5,000</span>
            <span className="block text-sm text-[var(--color-muted)] mt-1">Minimum</span>
          </div>
