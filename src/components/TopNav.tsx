    ...
    <>
      <nav className={cn(
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium transition-colors duration-300">
          <a href="#home" className={cn("hover:text-[#cc785c] transition-colors", scrolled ? "text-[#141413]" : "text-[#faf9f5]")}>Home</a>
          <a href="#services" className={cn("hover:text-[#cc785c] transition-colors", scrolled ? "text-[#141413]" : "text-[#faf9f5]")}>Services</a>
          <a href="#work" className={cn("hover:text-[#cc785c] transition-colors", scrolled ? "text-[#141413]" : "text-[#faf9f5]")}>Work</a>
          <a href="#packages" className={cn("hover:text-[#cc785c] transition-colors", scrolled ? "text-[#141413]" : "text-[#faf9f5]")}>Packages</a>
          <a 
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <nav className="flex flex-col items-center gap-8 text-2xl font-display text-[#faf9f5]">
              <a href="#home" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-[#cc785c] transition-colors">Home</a>
              <a href="#services" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-[#cc785c] transition-colors">Services</a>
              <a href="#work" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-[#cc785c] transition-colors">Work</a>
              <a href="#packages" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-[#cc785c] transition-colors">Packages</a>
              <a href="https://wa.me/923379912300" target="_blank" rel="noopener noreferrer" className="btn-primary mt-4 text-[16px] font-body flex items-center gap-2">
